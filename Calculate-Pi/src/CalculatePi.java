 ...
 * @author Nefari0uss
 * 
 *         This program will request the approximate number of calculations to
 *         run in calculating π. The final result will be displayed on the
 *         console. Assumption is that the user inputs an int.
 * 
 *
